...
void setup() {
  ...
  PImage friends = loadImage("Wilber-gimp.png");  // 2. Change this to match the name of your photo. 
  ...
  mustache = loadImage("M.jpg"); // 5. Change this to match your file name.
}
...
if(mousePressed){
  ...
  image(mustache, mouseX-60,mouseY-60);
}
